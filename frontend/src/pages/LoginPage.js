   ...
   <div className="flex items-center justify-center min-h-screen bg-teal-500">
     <div className="flex flex-col md:flex-row bg-white rounded-xl shadow-lg max-w-4xl mx-auto overflow-hidden">
       ...
       <div className="flex flex-col justify-center p-8 md:p-12 md:w-1/2">
         <h2 className="text-3xl font-bold text-gray-800 mb-5">Welcome Back!</h2>
       ...
       <div className="relative md:w-1/2">
         <img className="object-cover w-full h-full" src="https://plus.unsplash.com/premium_photo-1669833055160-e4ec2436a56c?q=80&w=2572&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" />
